                ...
                <div className={styles.controlsContainer}>
                    <div className={styles.searchWrapper}>
                        <div className={styles.searchBar}>
                            ...
                            <input
                                type="text"
                                placeholder="¿Qué fragancia buscás hoy?"
                                value={search}
                    ...
                    >
                        <div className={homeStyles.exclusiveHeader}>
                            ...
                            <p className={homeStyles.exclusiveSubtitle}>
                                Fragancias con precios especiales solo disponibles para clientes registrados
                            </p>
                        </div>
                        ...
                        >
                            <div className={homeStyles.comboBannerContent}>
                                ...
                                <p className={homeStyles.comboBannerText}>
                                    ...
                                    La mejor forma de ampliar tu colección de fragancias orientales.
                                </p>
